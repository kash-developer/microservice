...
class MainActivity : AppCompatActivity() {
    ...
    //donghee
    private var m_microservice_init = false
    private lateinit var m_command_processor: MicroServiceCommandProcessor
    //private lateinit var m_main_handler: Handler
    //private lateinit var m_my_runnable: Runnable
    //end of donghee
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //donghee
        Log.w(TAG, "create microservice processor")
        m_command_processor = MicroServiceCommandProcessor(this)
        m_command_processor.init()

        Log.w(TAG, "data path: " + applicationContext.filesDir.absolutePath)
        m_command_processor.setAssetManager(applicationContext.assets)
        m_command_processor.setBaseDir(applicationContext.filesDir.absolutePath)
        m_command_processor.copyAssetFolder(
            applicationContext,
            "",
        ...
        /*
        val file = File(applicationContext.filesDir.absolutePath + "/web")
        //deleteRecursive(file)
        m_command_processor.copyAssetFolder(
            applicationContext,
            "web",
            applicationContext.filesDir.absolutePath + "/web"
        )
        */
        //m_main_handler =  new Handler(applicationContext.getMainLooper())
    ...
    fun initMicroService() {
        Log.e(TAG, "let's init microservice")

        //donghee
        Log.e(TAG, "start the command processor")
        Log.e(TAG, "start the command processor")
        Log.e(TAG, "start the command processor")
        Log.e(TAG, "start the command processor")
        Log.e(TAG, "start the command processor")
    ...
    override fun onStart() {
        super.onStart()
        Log.e(TAG, "Main onStart: '$m_microservice_init'")
        ...
        if(m_microservice_init == false){
            m_microservice_init = true
            initMicroService()
        }
        else{
    ...
    //donghee
    public fun callFromMicroService(call_to: String) {
         Handler(Looper.getMainLooper()).post {
            // your codes here run on main Thread
            Log.w(TAG, "run call handler.....")
            callUri.setText(call_to)
            callButton.performClick()
            Log.w(TAG, "after call handler.....")
        }
    }

    public fun registerAccount() {
        Handler(Looper.getMainLooper()).post {
            // your codes here run on main Thread
            Log.w(TAG, "run account activity.....")
            startActivity(Intent(this, AccountActivity::class.java))
            Log.w(TAG, "after account activity.....")
        }
    }
    //end of donghee
}
